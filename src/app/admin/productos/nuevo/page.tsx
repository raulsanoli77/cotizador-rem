      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-8">
        ...
        <div>
          ...
          <div className="mb-6">
            ...
            <select required value={formData.categoria_id} onChange={handleCatChange} className="w-full md:w-1/2 border-gray-300 rounded-md focus:ring-brand-500 focus:border-brand-500 sm:text-sm">
              ...
              {selectedCat.campos_filtro.map((campo: any) => (
                <div key={campo.nombre}>
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    {campo.nombre.replace(/_/g, ' ')} {campo.unidad ? `(${campo.unidad})` : ''}
                  </label>
